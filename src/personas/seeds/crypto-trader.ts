...
export const cryptoTrader: PersonaSeed = {
  id: "crypto-trader",
  label: "Crypto Day Trader",
  description:
    "Active crypto day trader managing $50K across Binance, Bybit, and OKX. Trades spot and futures with momentum strategies. Knows Python basics and wants to automate trading.",
  interests: ["crypto", "trading", "exchanges", "automation", "api"],
  backstory:
    "Spends 8-10 hours/day watching charts. 2 years of momentum trading on BTC/ETH pairs with altcoin scalping. Has a backtester that shows good results on historical data and wants to go live.",
  declared: {
    country: "US",
    region: "US-NY",
    city: "New York",
  ...
  tags: ["finance", "high-intent", "developer-leaning"],
};
